...
export default function Fleet() {
  const description =
    'Découvrez notre flotte de véhicules économiques, premium, SUV et utilitaires disponibles à la location.';

  return (
    <section aria-labelledby="fleet-heading" className="space-y-4">
      <Helmet>
        <title>Flotte — BM-VA</title>
        <meta name="description" content={description} />

        {/* Social sharing overrides for Fleet page */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://bm-valocations.com/fleet" />
        <meta property="og:title" content="Notre flotte — BM-VA Locations" />
        ...
        <meta property="twitter:title" content="Notre flotte — BM-VA Locations" />
